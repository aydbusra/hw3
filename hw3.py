...
#report
#1 - According to the outcomes, moving average estimation is better than holt.
#2 - Smoothing the data helps to find better estimations because it eliminates the effects of trend and seasonality, but it makes the data lagging, it gets hard to get real results.
#3 - I would not change my window size for the next 2 minutes, but I would change them for the next day estimations to be able to find a more appropriate result.
